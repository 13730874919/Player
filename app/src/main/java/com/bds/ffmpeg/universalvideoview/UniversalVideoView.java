...
//        }
    ...
    UPlayer.OnPreparedListener mPreparedListener = new UPlayer.OnPreparedListener() {
        public void onPrepared(UPlayer mp) {
...
//            }
    ...
    @Override
    public void pause() {
        Log.d("XPLAY","pausepausepauseisInPlaybackState");
        if (isInPlaybackState()) {
            if (mMediaPlayer.isPlaying()) {
                mMediaPlayer.pause();
